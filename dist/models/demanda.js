...
const capital_builder_1 = require(
  "../utils/capital-builder"
);
const date_validator_1 = require(
  "../utils/date-validator"
);
const notificacion_1 = require(
  "./notificacion"
);
...
class ClassDemanda {
  constructor(
    ...
    this.medidasCautelares = {
      ...
      medidaSolicitada: medidaSolicitada ? String(
        medidaSolicitada
      ) : null,
    };
    ...
    this.municipio = municipio ? String(
      municipio
    ) : null;
    ...
    this.despacho = JUZGADO_EJECUCION
      ...
      : JUZGADO_ORIGEN
        ? JUZGADO_ORIGEN
        : null;
    this.llaveProceso = llaveProceso ? String(
      llaveProceso
    ) : null;
